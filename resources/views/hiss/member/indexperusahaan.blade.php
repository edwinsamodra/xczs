...
<div class="card m-5">
  ...
  <div class="col-lg-6 col-sm-md-12 card-body demo-vertical-spacing demo-only-element">
    <form method="GET" action="/pendaftaranPeserta">
    ...
    <table class="table table-sm">
      ...
      <tbody class="table-border-bottom-0">
        ...
        <tr>
          ...
          <td><a href="/pesertaperusahaan/{{ $company->company_kode }}"  data-id="{{ $company->company_kode }}">{{ $company->nama_perusahaan }}</a></td>
          <td>{{ $company->nama_pimpinan_perusahaan }}</td>
