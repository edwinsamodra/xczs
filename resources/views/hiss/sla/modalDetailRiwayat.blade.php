          ...
          <div class="col-3">
              <div class="card shadow-none">
                ...
                <div class="card-body  text-start"style="height: 500px; font-weight:bold;">
                  <img id="imgDetailPesertaContainer" src="fotokaryawan\profile.png">
                  <div class="text-center" style="margin-top: 50px; font-weight:bold;" id="txtnama"></div>
                  <div class="text-center" id="txtno_polis"></div>
                  <div class="text-center" id="txtNamaKaryawan"></div>
                  <div class="text-center"id="txtNomorPolis"></div>
            ...
            <div class="col-8">
              ...
              <h4>Info Karyawan</h4>
                  <div class="row">
                    ...
                    {{-- <div class="col-md-4"> --}}
                    <label for="html5-text-input" id="txNama_karyawan" class="col-md-4">:</label>
                    {{-- </div> --}}
                  </div>
                  <div class="mb-1 row">
                    <label for="html5-text-input" class="col-md-4">No Polis</label>
                    <div class="col-md-4">
                    <label for="html5-text-input" id="txno_polis" class="col-md-8">: </label>
                  ...
                  <div class="mb-1 row">
                    ...
                    <div class="col-md-8">
                    <label for="html5-text-input" id="txno_ktp" class="col-md-8">: </label>
                    </div>
                    </div>
                  <div class="mb-1 row">
                    <label for="html5-text-input" class="col-md-4">Perusahaan</label>
                    <div class="col-md-8">
                    <label for="html5-text-input" id="txnama_perusahaan" class="col-md-8">: </label>
                    </div>
                    </div>
                  ...
                  <div class="mb-1 row">
                    ...
                    <div class="col-md-8">
                    <label for="html5-text-input" id="txtgl_lahir" class="col-md-8">: </label>
                    </div>
                    </div>
                  <div class="mb-1 row">
                    <label for="html5-text-input" class="col-md-4">Jenis Kelamin</label>
                    <div class="col-md-8">
                    <label for="html5-text-input" id="txjenis_kelamin" class="col-md-8">: </label>
                    </div>
                    </div>
                    <div class="mb-1 row">
                    <label for="html5-text-input" class="col-md-4">Agama</label>
                    <div class="col-md-8">
                    <label for="html5-text-input" id="tx_agama" class="col-md-8">: </label>
                    </div>
                    </div>
                    <div class="mb-1 row">
                    <label for="html5-text-input" class="col-md-4">Golongan Darah</label>
                    <div class="col-md-8">
                    <label for="html5-text-input" id="txgolongan_darah" class="col-md-8">: </label>
                    </div>
                    </div>
                    </div>
                    </div>
