<!--modal Input-->
<div class="modal fade" id="modalDetailKepesertaanJKP" tabindex="-1" aria-labelledby="modalInputLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header"style="background-color:#0c5795; padding-bottom:1.2em;">
                <h5 class="modal-title text-white" id="modalInputLabelpeserta"></h5>
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <div class="card h-100">
                            <div class="container">
                                <div class="row mb-3">                                        
                                    <h5 class="text-center mt-5 mb-5" id="datakepesesrtaan"></h5>
                                    <div class="col-6">
                                        <div class="input-group">
                                            ...
                                            <span style="width:4em;">
                                                <input class="form-control border-end-0 border" type="text" placeholder="" id="modalKepesertaan_txtPage">
                                            </span>
                                            <button type="button" id="modalKepesertaan_btnPage" style="margin-left:-1em;background-color:#0c5795;z-index:998; color:white;" class="btn">Go</button>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="input-group  justify-content-end">
                                            <input class="form-control border-end-0 border" type="text" placeholder="" id="modalKepesertaan_keyword">
                                            <button type="button" id="modalKepesertaan_btnSearch" style="margin-left:-1em;background-color:#0c5795;z-index:998; color:white;" class="btn"><i class="fa fa-search"></i></button>
                                        </div> 
                                    </div> 
                                </div>  
                                <div class="row">
                                    <div id="modalKepesertaan_tableContainer" class="table-responsive text-nowrap mt-3"></div>
                                    <div class="mt-3 mb-3" id="modalKepesertaan_paginationContainer"></div>
                                </div>
                            </div>
                        </div>
                    </div>
