...
<div class="modal fade" id="modalTambahDataKeluarga" tabindex="-1" aria-labelledby="modalInputLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header"style="background-color:#0c5795;  padding-bottom:18px;">
        ...
        <div class="card mb-4">
          ...
          {{-- <input type="hidden" id="frmTambahDataKeluarga_member_id"> --}}
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-10">
                  <select name="kd_perusahaan" class="form-control" id="listhubungankeluarga">
                      <option value="0">-- Hubungan Keluarga --</option>
                      @foreach ($hubungankeluarga as $hubungankeluargas)
                          <option value="{{ $hubungankeluargas->id_dc_stat_keluarga }}">{{ $hubungankeluargas->hubungan_keluarga }}</option>
                      @endforeach
                  </select>
              </div>
            </div>
