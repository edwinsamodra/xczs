<!--modal Input-->
<div class="modal fade" id="modalDetailKepesertaanKK" tabindex="-1" aria-labelledby="modalInputLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header"style="background-color:#0c5795; padding-bottom:1.2em;">
                <h5 class="modal-title text-white" id="modalInputLabel">Jumlah Kepala Keluarga</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <div class="card h-100">
                            <div class="container">
                                <div class="row mb-3">                                        
                                    <h5 class="text-center mt-5 mb-5">Data Kepala Keluarga</h5>
                                    <div class="col-6">
