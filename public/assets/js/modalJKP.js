function renderTablejkp(page=1,keyword='')
{
    url = '/ajax/kepesertaan/jkp';
...
$(document).ready(function(){  
    $('#peserta_JKP').click(function(){
        $('#modalKepesertaan_keyword').val('');
        $('#modalKepesertaan_txtPage').val('');

        $('#modalDetailKepesertaanJKP').modal('show');
        $('#modalInputLabelpeserta').html('Jumlah JKP');
        $('#datakepesesrtaan').html('Data Peserta JKP');
