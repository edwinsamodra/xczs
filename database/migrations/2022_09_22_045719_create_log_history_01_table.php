...
class CreateLogHistory01Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('log_history_01', function (Blueprint $table) {
            ...
            $table->longText('nama_file')->nullable();
            ...
            $table->tinyInteger('jenis_sql')->nullable();
    ...
    {
        Schema::dropIfExists('log_history_01');
    }
}
