...
class CreateMtMasterTarifRsbhSemTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mt_master_tarif_rsbh_sem', function (Blueprint $table) {
            $table->integer('kode_tarif')->nullable();
            $table->string('kode_tindakan', 10)->nullable();
            $table->longText('nama_tarif')->nullable();
    ...
    {
        Schema::dropIfExists('mt_master_tarif_rsbh_sem');
    }
}
