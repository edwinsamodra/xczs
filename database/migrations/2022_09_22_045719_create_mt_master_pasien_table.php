...
class CreateMtMasterPasienTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mt_master_pasien', function (Blueprint $table) {
            ...
            $table->string('url_foto_pasien', 150)->nullable()->default('../assets/custom/Logo.png');
            ...
            $table->string('no_mr_ganti', 12)->nullable();
            $table->string('kode_klinik', 20)->nullable()->default('A00001');
            $table->integer('id_mt_master_pasien', true);
            $table->integer('kode_perusahaan_fktp')->nullable();
            $table->tinyInteger('status_aktif_bpjs')->nullable();
        });
    }
