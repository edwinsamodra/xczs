...
class CreateMtKlinikTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mt_klinik', function (Blueprint $table) {
            $table->integer('id_mt_klinik', true);
            $table->string('kode_klinik', 50)->nullable()->unique('kodeKlinik');
            ...
            $table->string('jenis_klinik')->nullable();
            $table->string('kelas_klinik')->nullable();
            $table->string('penyelenggara_klinik')->nullable();
            ...
            $table->string('nomer_hp', 50)->nullable();
            $table->tinyInteger('jenis_pklu')->nullable()->comment('1:Puskesmas,2:Klinik,3:RS');
