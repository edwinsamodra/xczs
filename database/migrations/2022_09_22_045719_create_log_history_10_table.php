...
class CreateLogHistory10Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('log_history_10', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('log_history_10');
    }
}
