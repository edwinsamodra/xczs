...
class CreateMtMasterPasien191127Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mt_master_pasien_191127', function (Blueprint $table) {
            $table->integer('id_mt_master_pasien');
            $table->string('no_mr', 50)->primary();
    ...
    {
        Schema::dropIfExists('mt_master_pasien_191127');
    }
}
