...
class CreateMtMcuTarifDetailRevisiTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mt_mcu_tarif_detail_revisi', function (Blueprint $table) {
            ...
            $table->integer('id_mt_mcu_detail_rev')->primary();
        });
    }
    ...
    {
        Schema::dropIfExists('mt_mcu_tarif_detail_revisi');
    }
}
