...
class CreateLogHistory06Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('log_history_06', function (Blueprint $table) {
            $table->integer('id_log_history');
    ...
    {
        Schema::dropIfExists('log_history_06');
    }
}
